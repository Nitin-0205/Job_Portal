...
export class Second1695714338837 implements MigrationInterface {
    name = 'Second1695714338837'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Employer" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" date, "deletedAt" date, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, "isDeleted" bit NOT NULL DEFAULT '0', "employerId" character varying NOT NULL, "company" character varying, CONSTRAINT "UQ_88be2a1dc03ba71371699f9822f" UNIQUE ("employerId"), CONSTRAINT "PK_e098b5394a9242bcf3e17331674" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Job" ("id" SERIAL NOT NULL, "jobId" character varying NOT NULL, "JobTitle" character varying NOT NULL, "description" character varying NOT NULL, "salary" integer NOT NULL, "location" character varying NOT NULL, "company" character varying NOT NULL, "type" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'open', "employerId" integer, CONSTRAINT "UQ_ecb0d5de3a5499d78ce6f079574" UNIQUE ("jobId"), CONSTRAINT "PK_981d90e7185b9ec1ee6b814ec21" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "projects_entity" ("id" SERIAL NOT NULL, "projectId" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "link" character varying NOT NULL, "from" character varying NOT NULL, "to" character varying NOT NULL, "applicantId" integer, CONSTRAINT "UQ_a8b8be19c284eafc3db15316aec" UNIQUE ("projectId"), CONSTRAINT "PK_b7b7e232c878fcdccdb3a18189b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "work_experience_entity" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" date, "deletedAt" date, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, "isDeleted" bit NOT NULL DEFAULT '0', "workExperienceId" character varying(50) NOT NULL, "company" character varying NOT NULL, "position" character varying NOT NULL, "from" character varying NOT NULL, "to" character varying NOT NULL, "current" character varying NOT NULL, "description" character varying NOT NULL, "location" character varying NOT NULL, "applicantId" integer, CONSTRAINT "UQ_65864e7bb8286abd85b2c0d07cb" UNIQUE ("workExperienceId"), CONSTRAINT "PK_999d4284d58652278922d429d34" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Applicant" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" date, "deletedAt" date, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, "isDeleted" bit NOT NULL DEFAULT '0', "applicantId" character varying NOT NULL, "skills" character varying array, "file" character varying, CONSTRAINT "UQ_b3ed6c8dac1185b71ab7f38280c" UNIQUE ("applicantId"), CONSTRAINT "PK_e68a6314b718c9314489ea19270" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" date, "deletedAt" date, "createdBy" character varying, "updatedBy" character varying, "deletedBy" character varying, "isDeleted" bit NOT NULL DEFAULT '0', "userId" character varying NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "phone" character varying NOT NULL, "address" character varying NOT NULL, "role" character varying NOT NULL, CONSTRAINT "UQ_45f0625bd8172eb9c821c948a0f" UNIQUE ("userId"), CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`);
